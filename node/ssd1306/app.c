...
#define THIS_COMPANY    3 //for ssd1306
...
void App_init(const app_global_functions_t * functions)
{
    ...
    Printf("\r\n-------- ssd1306 project by hks. 2023.09.06 17:18 -----------\r\n");
#else 
    Printf("\r\n++++++++++ Tokai Encryption type. 2022.12.02 10:55 LATENCY_MODE ++++++++++++++\r\n");
#endif
    
    Printf("default_network_channel: Test, 30\r\n");
    Printf("default_network_cipher_key ?= 0x01,0x30,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x10,0x11,0x12,0x13,0x14,0x15\r\n");
    Printf("test: %s\r\n", "hong test");
    displayDeviceId();
